...
export default function Gallery () {
    ...
    {/* <div className="relative overflow-hidden bg-green-500">
        ...
        <div className="flex justify-center p-5 m-5 bg-red-500 card-container">
            {duplicatedCards.slice(currentIndex, currentIndex + 3).map((card, index) => (
                <div key={index} className="flex-shrink-0 relative w-1/3 card">

                        <div className={`${index === 1 ? 'scale-125' : 'scale-75 transition-opacity opacity-70'} p-5 bg-slate-800 rounded-md text-white font-light`}> 
                            <div className='flex flex-col'>
